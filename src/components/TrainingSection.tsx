            ...
            <div className="w-full md:w-[60%] p-8 md:p-10 flex flex-col justify-center">
              <div className="max-w-xl">
                ...
                <Button
                  ...
                  className="bg-accent text-accent-foreground hover:bg-gold-light rounded-none px-10 py-7 text-[14px] font-semibold uppercase tracking-[0.15em] shadow-[0_0_20px_hsl(var(--accent)/0.4)] motion-reduce:animate-none animate-[pulse_24s_ease-in-out_infinite] transition-all duration-300 hover:shadow-[0_0_30px_hsl(var(--accent)/0.6)]"
                >
